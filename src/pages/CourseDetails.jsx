...
const CourseDetails = () => {
    ...
    if (!courseDetail) return <div className='flex justify-center items-center h-screen'>
        <div className='custom-loader'>  hello</div>
    </div>
                ...
                <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
                    ...
                    <div className='z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5'>
                        ...
                        <div className='flex gap-x-3 items-center'>
                            <span className='text-yellow-50'>{0}</span>
                    ...
                    <div className='flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden'>
                        ...
                        {ACCOUNT_TYPE.INSTRUCTOR !== user?.accountType &&
                            <>
                                {
                                    alreadyEnrolled ? <button onClick={() => { navigate("/dashboard/enrolled-courses") }} className='yellowButton'>Go to Course</button> : <button className='yellowButton' onClick={handelPayment}>Buy Now</button>
                                }
                                {
                                ...
                                <div className='flex flex-col gap-1 text-sm text-caribbeangreen-100'>
                                    {
                                        (() => {
                                            try {
                                                const parsed = typeof courseDetail?.instructions === "string"
                                                ...
                                                console.error("Invalid JSON in instructions:", err);
                                                return null;
                                            }
                                        })()
                                    }
